...
proc create_new_project_label_axi { }\
{
	...
	puts "-----------MiV_RV32IMA_L1_AXI_BaseDesign_PF_Avalanche_ES-----------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "-----------MiV_RV32IMA_L1_AHB_BaseDesign_PF_Avalanche_ES-----------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
# ##
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_PF_Avalanche_ES_AHB_ProgramFile} \
