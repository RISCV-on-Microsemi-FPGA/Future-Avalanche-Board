...
set Libero_project_name_CFG1 PF_Avalanche_ES_MiV_RV32IMA_CFG1_BaseDesign

set project_folder_name_CFG2 MiV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 PF_Avalanche_ES_MiV_RV32IMA_CFG2_BaseDesign
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {PF_Avalanche_ES_MiV_RV32IMA_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Avalanche_ES_MiV_RV32IMA_CFG2_BaseDesign} \
